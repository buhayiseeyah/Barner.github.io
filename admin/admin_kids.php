...
<body>
	...
	<div>
		<?php
			...
			if (!$check){
				echo "<p class='edit'>Error acquiring list of children: </p>" . mysqli_error($link);
				exit();
			}
			
			else if(($row = mysqli_fetch_array($check)) == NULL) echo "<br><p class='edit'>No children has been registered yet.</p><br>";
			...
			if(array_key_exists('kidchange', $_POST)){
				...
				else header('Location: admin_kids.php');
			}
