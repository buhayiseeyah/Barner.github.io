...
<body>
	...
	<div>
		<?php
			...
			if (!$check){
				echo "<p class='edit'>Error acquiring list of sponsors: </p>" . mysqli_error($link);
				exit();
			}
			
			else if(($row = mysqli_fetch_array($check)) == NULL) echo "<br><p class='edit'>No sponsors has been registered yet.</p><br>";
